class SollPr134 < Formula
  ...
  version "0.0.0-pr.134.fffa4d7b"
  license :cannot_represent

  on_macos do
    url "https://github.com/marginallyuseful/homebrew-soll-preview/releases/download/pr-134-fffa4d7b/soll-pr-134-macos-arm64"
    sha256 "4785409b8276be4da43514b001f2c29e995ae1915728c3193d3dfc98eb10cdec"
  end

  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/marginallyuseful/homebrew-soll-preview/releases/download/pr-134-fffa4d7b/soll-pr-134-linux-arm64"
      sha256 "2226b24d54333869f5c729584e7095a714317b187d2c6d8a6544b8e399a6054a"
    end
    if Hardware::CPU.intel?
      url "https://github.com/marginallyuseful/homebrew-soll-preview/releases/download/pr-134-fffa4d7b/soll-pr-134-linux-x64"

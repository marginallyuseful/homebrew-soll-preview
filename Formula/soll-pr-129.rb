class SollPr129 < Formula
  ...
  version "0.0.0-pr.129.b3583d75"
  license :cannot_represent

  on_macos do
    url "https://github.com/marginallyuseful/homebrew-soll-preview/releases/download/pr-129-b3583d75/soll-pr-129-macos-arm64"
    sha256 "1d4d57cf8351b83e0ef47a941e3c46d71cd628d666de74c375fa1eaaf107b497"
  end

  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/marginallyuseful/homebrew-soll-preview/releases/download/pr-129-b3583d75/soll-pr-129-linux-arm64"
      sha256 "60705a8e06e0ca7e487b30bb0817aff77f23ca69f652ff8f5eb80c7dda5bb267"
    end
    if Hardware::CPU.intel?
      url "https://github.com/marginallyuseful/homebrew-soll-preview/releases/download/pr-129-b3583d75/soll-pr-129-linux-x64"

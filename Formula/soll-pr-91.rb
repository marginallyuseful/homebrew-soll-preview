class SollPr91 < Formula
  ...
  version "0.0.0-pr.91.b9b63c70"
  license :cannot_represent

  on_macos do
    url "https://github.com/marginallyuseful/homebrew-soll-preview/releases/download/pr-91-b9b63c70/soll-pr-91-macos-arm64"
    sha256 "931d15ff69d69f0d259d209349b367670ec8deb60723ef539f355fe9cfb5f4ae"
  end

  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/marginallyuseful/homebrew-soll-preview/releases/download/pr-91-b9b63c70/soll-pr-91-linux-arm64"
      sha256 "e6f733233b97c9a3f575f114e35aeef200da8c8a6ac2afaa6bf3b114cf1bb99f"
    end
    if Hardware::CPU.intel?
      url "https://github.com/marginallyuseful/homebrew-soll-preview/releases/download/pr-91-b9b63c70/soll-pr-91-linux-x64"
